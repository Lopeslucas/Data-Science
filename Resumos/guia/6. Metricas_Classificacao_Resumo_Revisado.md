...
***Precision mede, entre os casos classificados como positivos, quantos realmente são positivos. Recall mede, entre os positivos reais, quantos o modelo conseguiu identificar. Eu priorizaria precision quando falsos positivos tiverem custo alto, e recall quando falsos negativos forem mais prejudiciais.**

**Então, um exemplo lúdico, por exemplo, a classificação de pessoas com uma doença. Nesse caso, a gente pode acabar priorizando o falso negativo, ao invés do falso positivo, porque é muito melhor que a gente tenha ali uma classificação de falso positivo e a pessoa siga para demais exames e se prove que ela não tem a doença, do que a gente dizer que ela não possui e ela não dar sequência ali, não iniciar o tratamento, o que pode ser muito danoso à vida dessas pessoas.**
