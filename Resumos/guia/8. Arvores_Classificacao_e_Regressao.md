...
***Árvores conseguem modelar relações com variáveis numéricas e categóricas, mas algumas implementações, como a do scikit-learn, aceitam somente entradas numéricas. Por isso, categorias precisam ser codificadas, respeitando sua natureza nominal ou ordinal. Modelos como CatBoost possuem tratamento categórico nativo e podem dispensar o one-hot tradicional.***
